...
I took this course to build a foundation in enterprise network security, with a focus on Huawei's firewall technologies specifically, since I keep running into Huawei equipment in cloud and enterprise security contexts here.

By the end, I wanted to be able to:

- Explain core network security concepts and threats without having to look them up.
- Understand where firewalls fit into an enterprise network and what they're protecting against.
