...
## High Level Flow
Traffic hits policy requiring auth → firewall challenges user → user authenticates (local or external server) → traffic reevaluated against policies tied to user/group identity
