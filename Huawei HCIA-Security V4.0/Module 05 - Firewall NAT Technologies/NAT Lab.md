...
This is the built-in lab from Module 05, covering source NAT and NAT Server configuration on a Huawei firewall, through both the CLI and the Web UI. Documented as a summary of what the exercise covers.
