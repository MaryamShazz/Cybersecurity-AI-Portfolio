...
This is the built-in lab from Module 11, covering site-to-site IPSec VPN configuration between two firewalls on the course's simulated environment. Documented as a summary of what the exercise covers.
...
3. Setting a pre-shared key for IKE authentication between the two peers.
